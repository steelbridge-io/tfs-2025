...
<div class="modal fade" id="seasonsModal" tabindex="-1" aria-labelledby="seasonsModalLabel"
 ...
 <div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
   <div class="modal-header">
    <h5 class="modal-title" id="seasonsModalLabel">Seasons At <?php echo $feature_2_seasons_title; ?></h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
   </div>
   <div class="modal-body">
...
<div class="modal fade" id="gettingtoModal" tabindex="-1" aria-labelledby="gettingtoModalLabel"
 ...
 <div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
   <div class="modal-header">
    <h5 class="modal-title" id="gettingtoModalLabel">Getting To <?php echo $feature_3_get_to_title; ?></h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
   </div>
   <div class="modal-body">
