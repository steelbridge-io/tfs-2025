 ...
 <div id="regional-v2" class="container">
     ...
     <div class="image position-relative">
      <!-- Feature #1 Video/Text/Image Option -->
       ...
       <div class="ratio ratio-16x9 video-poster">
        <video id="videoPlayer"
			...
			<?php } else {
			 if (!empty($feature_pw1_image)) { ?>
        <img src="<?php echo $feature_pw1_image; ?>"
      ...
      <!-- Overlay containers that will be toggled with JS -->
       ...
       <div id="nonInclusionsOverlay" class="content-overlay">
        ...
        <div class="overlay-content">
         <p class="travel"><?php echo $feature_pw1_noninclusions_textarea; ?></p>
			...
			<?php if (!empty($feature_pw1_packagedeal_textarea)) : ?>
       <div id="packageDealOverlay" class="content-overlay">
        ...
        <div class="overlay-content">
         <p class="travel"><?php echo $feature_pw1_packagedeal_textarea; ?></p>
        </div>
       </div>
			<?php endif; ?>
     </div>
      ...
      <!-- Seasons Video/Text/Image Option -->
       ...
       <div class="ratio ratio-16x9 video-poster">
        <video id="videoPlayer"
			...
			<?php else: ?>
       <img src="<?php echo $feature_pw2_image; ?>"
            alt="The Fly Shop Guide Service Image"/>
			<?php endif; ?>

      <!-- Overlay containers for seasons information -->
			<?php if (!empty($feature_pw2_seasons_readmore)) : ?>
       <div id="readMoreOverlay" class="content-overlay">
        ...
        <div class="overlay-content">
         <p class="travel"><?php echo $feature_pw2_seasons_readmore; ?></p>
        </div>
       </div>
			<?php endif; ?>
       ...
       <div class="content-buttons">
         ...
         <button class="info-button" data-target="readMoreOverlay">
          Read More<i class="lni lni-chevron-right"></i>
					<?php if (!empty($feature_pw2_seasons_readmore_info)) {
					 echo '<span class="readmore-info">'
								. $feature_pw2_seasons_readmore_info
								. '</span>';
					} ?>
         </button>
				<?php endif; ?>
  ...
  <section class="spotlight">
   <div class="row regional-waters">
    <div class="col-md-12 col-lg-12 regional-waters-container">
     <div class="image position-relative">
      <!-- Feature #3 Video/Text/Image Option -->
			<?php
			if (!empty($video_pwfeature_three)) :?>
       <div class="ratio ratio-16x9 video-poster">
        <video id="videoPlayer"
               src="<?php echo $video_pwfeature_three; ?>"
               poster="<?php echo $feature_pw3_fishing_image; ?>"
               controls allowfullscreen>
        </video>
       </div>
			<?php else: ?>
       <img src="<?php echo $feature_pw3_fishing_image; ?>"
            alt="The Fly Shop Guide Service Image"/>
			<?php endif; ?>

      <!-- Overlay container for read more content -->
			<?php if (!empty($feature_pw3_fishing_readmore)) : ?>
       <div id="fishingReadMoreOverlay" class="content-overlay">
        ...
        <div class="overlay-content">
         <p class="travel"><?php echo $feature_pw3_fishing_readmore; ?></p>
        </div>
       </div>
			<?php endif; ?>
     </div>
	 ...
	 <div id="travel-style" class="privatewaters3">
		...
		<div class="accordion" id="accordion-beat1">
		 ...
		 if(!empty($fishing_beat1_label)) :?>
			...
			<div id="beat-1" class="accordion-item fishing-beat-1">
			 <h2 class="accordion-header">
				<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-beat1" aria-expanded="false" aria-controls="collapse-beat1">
				 <h4 class="panel-title travel mb-0"><?php echo $fishing_beat1_label; ?>&nbsp;<span class="arrow-down"></span></h4>
				</button>
			 </h2>
		 ...
		 if(!empty($fishing_beat2_label)) :?>
			...
			<div id="beat-2" class="accordion-item fishing-beat-2">
			 <h2 class="accordion-header">
				<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-beat2" aria-expanded="false" aria-controls="collapse-beat2">
				 <h4 class="panel-title travel mb-0"><?php echo $fishing_beat2_label; ?>&nbsp;<span class="arrow-down"></span></h4>
				</button>
			 </h2>
		 ...
		 if(!empty($fishing_beat3_label)) :?>
			...
			<div id="beat-3" class="accordion-item fishing-beat-3">
			 <h2 class="accordion-header">
				<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-beat3" aria-expanded="false" aria-controls="collapse-beat3">
				 <h4 class="panel-title travel mb-0"><?php echo $fishing_beat3_label; ?>&nbsp;<span class="arrow-down"></span></h4>
				</button>
			 </h2>
		 ...
		 if(!empty($fishing_beat4_label)) :?>
			...
			<div id="beat-4" class="accordion-item fishing-beat-4">
			 <h2 class="accordion-header">
				<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-beat4" aria-expanded="false" aria-controls="collapse-beat4">
				 <h4 class="panel-title travel mb-0"><?php echo $fishing_beat4_label; ?>&nbsp;<span class="arrow-down"></span></h4>
				</button>
			 </h2>
		 ...
		 if(!empty($fishing_beat5_label)) :?>
			...
			<div id="beat-5" class="accordion-item fishing-beat-5">
			 <h2 class="accordion-header">
				<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-beat5" aria-expanded="false" aria-controls="collapse-beat5">
				 <h4 class="panel-title travel mb-0"><?php echo $fishing_beat5_label; ?>&nbsp;<span class="arrow-down"></span></h4>
				</button>
			 </h2>
		 ...
		 if(!empty($fishing_beat6_label)) :?>
			...
			<div id="beat-6" class="accordion-item fishing-beat-6">
			 <h2 class="accordion-header">
				<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-beat6" aria-expanded="false" aria-controls="collapse-beat6">
				 <h4 class="panel-title travel mb-0"><?php echo $fishing_beat6_label; ?>&nbsp;<span class="arrow-down"></span></h4>
				</button>
			 </h2>
      ...
      <!-- Guide Service Video/Text/Image Option -->
       ...
       <div class="ratio ratio-16x9 video-poster">
        <video id="videoPlayer"
			...
			<?php else: ?>
       <img src="<?php echo $feature_4_pwlodging_image; ?>"
    ...
    <div class="col-md-6 col-lg-6 regional-waters-container">
     <div class="image position-relative">
      <!-- Video/Text/Image Option -->
			<?php
			if (!empty($video_pwfeature_five)) : ?>
       <div class="ratio ratio-16x9 video-poster">
        <video id="videoPlayer"
               src="<?php echo $video_pwfeature_five; ?>"
               poster="<?php echo $feature_pw5_gettingto_image; ?>"
               controls allowfullscreen>
        </video>
       </div>
			<?php else: ?>
       <img src="<?php echo $feature_pw5_gettingto_image; ?>"
        ...
        <div class="content-buttons">
         <button class="info-button" data-target="gettingToReadMoreOverlay">
          <i class="lni lni-chevron-left"></i>Read More
					<?php if (!empty($feature_pw5_readmore_info)) {
					 echo '<span class="readmore-info">'
								. $feature_pw5_readmore_info
								. '</span>';
					} ?>
         </button>
        </div>
