<?php
/**
 * Template Name: Fly Fishing Schools
...
$default = '';
get_header('fly-fishing-schools');
 ...
 <div id="guide-template-grid" class="container container-xxl mt-5 mb-5 pt-5 pb-5">
  ...
  <div class="row travel-template-row justify-content-center pt-4 pb-5 pr-2 pl-2 g-5">
    ...
    <div class="col-md-6 col-lg-6 three">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_3_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_3; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 five">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_5_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_5; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 six">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_6_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_6; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 seven">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_7_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_7; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 eight">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_8_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_8; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 nine">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_9_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_9; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 ten">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_10_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_10; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 eleven">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_11_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_11; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 tweleve">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_12_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_12; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirteen">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_13_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_13; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 fouteen">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_14_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_14; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 fifteen">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_15_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_15; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 sixteen">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_16_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_16; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 seventeen">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_17_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_17; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 eighteen">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_18_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_18; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 nineteen">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_19_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_19; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 twenty">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_20_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_20; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 twentyone">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_21_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_21; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 twentythree">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_23_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_23; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 twentyfour">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_24_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_24; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 twentyfive">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_25_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_25; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 twentysix">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_26_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_26; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 twentyseven">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_27_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_27; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 twentyeight">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_28_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_28; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 twentynine">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_29_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_29; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirty">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_30_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_30; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirtyone">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_31_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_31; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirtytwo">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_32_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_32; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirtythree">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_33_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_33; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirtyfour">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_34_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_34; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirtyfive">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_35_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_35; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirtysix">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_36_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_36; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirtyseven">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_37_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_37; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirtyeight">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_38_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_38; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 thirtynine">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_39_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_39; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 fourty">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_40_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_40; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 fourtyone">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_41_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_41; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
    ...
    <div class="col-md-6 col-lg-6 fourtytwo">
     <div class="thumbnail signature-text-color">
      <a class="thumbnail-link" href="<?php echo $signature_image_42_title_link; ?>" target="_self" title="Signature Destination"><img src="<?php echo $signature_image_42; ?>"></a>
      <section id="" class="widget-section">
       <div class="caption sig-caption">
