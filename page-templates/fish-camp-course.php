<?php
/**
 * Template Name: Fish Camp Course Template
...
<?php endif; ?>
      ...
      <div id="travel-style" class="fishcamp2">
       ...
       if(!empty($feature_fc2_readmore_textarea)) :?>
        <div class="accordion" id="accordiondates">
         <div class="accordion-item fishcamp2">
           ...
           <div id="collapseOnedates" class="accordion-collapse collapse" data-bs-parent="#accordiondates">
            <div class="accordion-body fishcamp2">
      ...
      <div id="travel-style" class="fishcamp4">
       ...
       if(!empty($feature_4_fclodging_readmore)) :?>
        <div class="accordion" id="accordion4">
         <div class="accordion-item fishcamp4">
     ...
     <div class="additional-listing">
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image1', true)) {
       ...
       '<div class="thumbnail">',
        ...
        '<a href="#fishcamp-carousel" data-bs-slide-to="0"><img src="' . $fish_camp_additional_info_image1 . '" class="img-fluid destination-img" data-bs-toggle="modal" data-bs-target="#fishcampTableModal" alt="The Fly Shop Images"></a>',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image2', true)) {
       ...
       '<div class="thumbnail">',
        ...
        '<a href="#fishcamp-carousel" data-bs-slide-to="1"><img src="' . $fish_camp_additional_info_image2 . '" class="img-fluid destination-img" data-bs-toggle="modal" data-bs-target="#fishcampTableModal" alt="The Fly Shop Images"></a>',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image3', true)) {
       ...
       '<div class="thumbnail">',
        ...
        '<a href="#fishcamp-carousel" data-bs-slide-to="2"><img src="' . $fish_camp_additional_info_image3 . '" class="img-fluid destination-img" data-bs-toggle="modal" data-bs-target="#fishcampTableModal" alt="The Fly Shop Images"></a>',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image4', true)) {
       ...
       '<div class="thumbnail">',
        ...
        '<a href="#fishcamp-carousel" data-bs-slide-to="3"><img src="' . $fish_camp_additional_info_image4 . '" class="img-fluid destination-img" data-bs-toggle="modal" data-bs-target="#fishcampTableModal" alt="The Fly Shop Images"></a>',
     ...
     <div class="additional-listing">
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image5', true)) {
       ...
       '<div class="thumbnail">',
        ...
        '<a href="#fishcamp-carousel" data-bs-slide-to="4"><img src="' . $fish_camp_additional_info_image5 . '" class="img-fluid destination-img" data-bs-toggle="modal" data-bs-target="#fishcampTableModal" alt="The Fly Shop Images"></a>',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image6', true)) {
       ...
       '<div class="thumbnail">',
        ...
        '<a href="#fishcamp-carousel" data-bs-slide-to="5"><img src="' . $fish_camp_additional_info_image6 . '" class="img-fluid destination-img" data-bs-toggle="modal" data-bs-target="#fishcampTableModal" alt="The Fly Shop Images"></a>',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image7', true)) {
       ...
       '<div class="thumbnail">',
        ...
        '<a href="#fishcamp-carousel" data-bs-slide-to="6"><img src="' . $fish_camp_additional_info_image7 . '" class="img-fluid destination-img" data-bs-toggle="modal" data-bs-target="#fishcampTableModal" alt="The Fly Shop Images"></a>',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image8', true)) {
       ...
       '<div class="thumbnail">',
        ...
        '<a href="#fishcamp-carousel" data-bs-slide-to="7"><img src="' . $fish_camp_additional_info_image8 . '" class="img-fluid destination-img" data-bs-toggle="modal" data-bs-target="#fishcampTableModal" alt="The Fly Shop Images"></a>',
 ...
 <div class="modal fade fishcamp-modal additional-img" tabindex="-1" id="fishcampTableModal"
      aria-labelledby="fishcampTableModalLabel" aria-hidden="true">
     ...
     <div class="carousel-inner">
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image1', true)) {
       ...
       echo	'<div class="carousel-item active">',
        ...
        '<img class="d-block w-100 destination-img" src="' . $fish_camp_additional_info_image1 . '" alt="The Fly Shop World Fly Fishing Travel">',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image2', true)) {
       ...
       echo	'<div class="carousel-item">',
        ...
        '<img class="d-block w-100 destination-img" src="' . $fish_camp_additional_info_image2 . '" alt="The Fly Shop World Fly Fishing Travel">',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image3', true)) {
       ...
       echo 	'<div class="carousel-item">',
        ...
        '<img class="d-block w-100 destination-img" src="' . $fish_camp_additional_info_image3 . '" alt="The Fly Shop World Fly Fishing Travel">',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image4', true)) {
       ...
       echo	'<div class="carousel-item">',
        ...
        '<img class="d-block w-100 destination-img" src="' . $fish_camp_additional_info_image4 . '" alt="The Fly Shop World Fly Fishing Travel">',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image5', true)) {
       ...
       echo	'<div class="carousel-item">',
        ...
        '<img class="d-block w-100 destination-img" src="' . $fish_camp_additional_info_image5 . '" alt="The Fly Shop World Fly Fishing Travel">',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image6', true)) {
       ...
       echo	'<div class="carousel-item">',
        ...
        '<img class="d-block w-100 destination-img" src="' . $fish_camp_additional_info_image6 . '" alt="The Fly Shop World Fly Fishing Travel">',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image7', true)) {
       ...
       echo	'<div class="carousel-item">',
        ...
        '<img class="d-block w-100 destination-img" src="' . $fish_camp_additional_info_image7 . '" alt="The Fly Shop World Fly Fishing Travel">',
      ...
      <?php if(get_post_meta(get_the_ID(), 'fish-camp-additional-info-image8', true)) {
       ...
       echo	'<div class="carousel-item">',
        ...
        '<img class="d-block w-100 destination-img" src="' . $fish_camp_additional_info_image8 . '" alt="The Fly Shop World Fly Fishing Travel">',
  ...
  <div class="inner container">
   <div id="cta-trigger" class="cta-trigger-area">
    <header class="text-center">
     <h2 class="cta-trigger-title"><?php echo $cta_fish_camp_strong_intro;?></h2>
     <p class="cta-trigger-subtitle"><?php echo $cta_fish_camp_content;?></p>
