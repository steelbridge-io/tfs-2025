		 ...
		 <div class="panel panel-default section-margin">
			<div class="panel-body">
			 <div class="row">
				...
				echo '<div class="more-btn row">
                <div class="col-lg-12">
                <button class="btn btn-dark" type="button" data-toggle="collapse" data-target="#collapse-news-archive-five" aria-expanded="false" aria-controls="collapse-news-archive-five">
                See more News articles
                </button>
                </div>
                </div>
