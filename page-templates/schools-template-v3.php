<?php
    ...
    */
    ...
    /**
     * This is the meta field file for the Schools Template.
    ...
    <section id="tabbed-destination-content" class="container-fluid mt-5">
      <div class="container">
          ...
          <ul class="nav nav-pills nav-tabs destination-tabs" id="destinationTabs" role="tablist">
              ...
              <?php endif;
              if ($feature_5_itinerary_img !== '') : ?>
                  <li class="nav-item" role="presentation">
                      <button class="nav-link" id="itinerary-tab" data-bs-toggle="tab" data-bs-target="#itinerary-pane"
                              type="button" role="tab" aria-controls="itinerary-pane" aria-selected="false">
                          <i class="lni lni-fish-1"></i> <?php echo $feature_5_itinerary_title ?>
                      </button>
                  </li>
              <?php endif;
              if ($feature_6_supplemental_img !== '') : ?>
              <li class="nav-item" role="presentation">
               <button class="nav-link" id="supplemental-tab" data-bs-toggle="tab" data-bs-target="#supplemental-pane"
                       type="button" role="tab" aria-controls="supplemental-pane" aria-selected="false">
                <i class="lni lni-fish-2"></i> <?php echo $feature_6_supplemental_title ?>
               </button>
              </li>
              <?php endif; ?>
          </ul>
          ...
          <div class="tab-content destination-tab-content" id="destinationTabContent">
                      ...
                      <div class="tab-container-wrapper">
                          ...
                          <div class="feature-content inclusions-content">
                           ...
                           ?>
                              ...
                              <?php
                              if (!empty($feature_1_cost_textarea)) {
                                  echo '<div>' . $feature_1_cost_textarea . '</div>';
                              }

                              if (!empty($feature_1_inclusions_textarea)) {
                                  echo '<div><b>Inclusions:</b>&nbsp;' . $feature_1_inclusions_textarea . '</div>';
                              }

                              if (!empty($feature_1_noninclusions_textarea)) {
                                  echo '<div><b>Non-Inclusions:</b>&nbsp;' . $feature_1_noninclusions_textarea . '</div>';
                              }
              ...
              <!-- Angling Tab -->
              <div class="tab-pane fade" id="itinerary-pane" role="tabpanel" aria-labelledby="itinerary-tab">
                  <?php if ($feature_5_itinerary_img !== '') : ?>
                      <div class="tab-container-wrapper">
                          <div id="itineraryAtdestination" class="readmore-info">
                              <div class="overlay-header">
                                  <h3>Angling Details</h3>
                                  <button class="close-overlay">&times;</button>
                              </div>
                              <div class="overlay-content">
                                  <div><?php echo $feature_5_itinerary_content . '&nbsp;' . $feature_5_itinerary_readmore ?></div>
                              </div>
                          </div>
                          ...
                          <div class="feature-image">
                              ...
                              if ($feature_5_video_src) :
                                  ?>
                                  <div class="ratio ratio-16x9">
                                      <video class="w-100" controls playsinline preload="metadata" poster="<?php echo esc_url($feature_5_itinerary_img); ?>">
                                          <source src="<?php echo $feature_5_video_src; ?>" type="video/mp4">
                                          Your browser does not support the video tag.
                                      </video>
                                  </div>
                              <?php else: ?>
                                  <img class="img-fluid" src="<?php echo esc_url($feature_5_itinerary_img); ?>" alt="The Fly Shop Travel Image">
                              <?php endif; ?>
                          </div>

                          <!-- Content below image -->
                          <div class="feature-content">
                              <h2><?php echo $feature_5_itinerary_title ?></h2>
                              <?php
                              echo '<div><p>' . $feature_5_itinerary_content . '</p></div>';

                              if (!empty($feature_5_itinerary_readmore)) :
                               echo '<button type="button" class="btn destination btn-tfs" data-target="itineraryAtdestination">Read more...</button>';
                              endif;
                              ?>
                          </div>
                      </div>
             ...
             <!-- Species Tab -->
             <div class="tab-pane fade" id="supplemental-pane" role="tabpanel" aria-labelledby="supplemental-tab">
              <?php if ($feature_6_supplemental_img !== '') : ?>
               <div class="tab-container-wrapper">
                <div id="supplementalReadmore" class="readmore-info">
                 <div class="overlay-header">
                  <h3>Species Details</h3>
                  <button class="close-overlay">&times;</button>
                 </div>
                 <div class="overlay-content">
                  <div><?php echo $feature_6_supplemental_content . '&nbsp;' . $feature_6_supplemental_readmore ?></div>
                 </div>
                </div>
                ...
                <div class="feature-image">
                 ...
                 if ($feature_6_video_src) :
                  ?>
                  <div class="ratio ratio-16x9">
                   <video class="w-100" controls playsinline preload="metadata" poster="<?php echo esc_url($feature_6_supplemental_img); ?>">
                    <source src="<?php echo $feature_6_video_src; ?>" type="video/mp4">
                    Your browser does not support the video tag.
                   </video>
                  </div>
                 <?php else: ?>
                  <img class="img-fluid" src="<?php echo esc_url($feature_6_supplemental_img); ?>" alt="The Fly Shop Species Image">
                 <?php endif; ?>
                </div>

                <!-- Content below image -->
                <div class="feature-content">
                 <h2><?php echo $feature_6_supplemental_title ?></h2>
                 <?php
                 echo '<div><p>' . $feature_6_supplemental_content . '</p></div>';

                 if (!empty($feature_6_supplemental_readmore)) :
                  echo '<button type="button" class="btn destination btn-tfs" data-target="supplementalReadmore">Read more...</button>';
                 endif;
                 ?>
                </div>
               </div>
                    ...
                    <div class="additional-listing">
                        ...
                        <?php if (get_post_meta(get_the_ID(),
                            ...
                            '<div class="thumbnail">',
                                    ...
                                    '<a href="#schoolv3-carousel" data-slide-to="0"><img class="destination-img" src="'
                                    . $additional_schoolv3_image1
                        ...
                        <?php if (get_post_meta(get_the_ID(),
                            ...
                            '<div class="thumbnail">',
                                    ...
                                    '<a href="#schoolv3-carousel" data-slide-to="1"><img class="destination-img" src="'
                                    . $additional_schoolv3_image2
                                    . '" data-bs-toggle="modal" data-bs-target="#travelTableModal" alt="The Fly Shop Images"></a>',
                        ...
                        <?php if (get_post_meta(get_the_ID(),
                            ...
                            '<div class="thumbnail">',
                                    ...
                                    '<a href="#schoolv3-carousel" data-slide-to="2"><img class="destination-img" src="'
                                    . $additional_schoolv3_image3
                                    . '" data-bs-toggle="modal" data-bs-target="#travelTableModal" alt="The Fly Shop Images"></a>',
                        ...
                        <?php if (get_post_meta(get_the_ID(),
                            ...
                            echo '<div class="col-xs-6 col-md-3">',
                                    ...
                                    '<a href="#schoolv3-carousel" data-slide-to="3"><img class="destination-img" src="'
                                    . $additional_schoolv3_image4
                                    . '" data-bs-toggle="modal" data-bs-target="#travelTableModal" alt="The Fly Shop Images"></a>',
                    ...
                    <div class="additional-listing">
                        ...
                        <?php if (get_post_meta(get_the_ID(),
                            ...
                            '<div class="thumbnail">',
                                    ...
                                    '<a href="#schoolv3-carousel" data-slide-to="4"><img class="destination-img" src="'
                                    . $additional_schoolv3_image5
                                    . '" data-bs-toggle="modal" data-bs-target="#travelTableModal" alt="The Fly Shop Images"></a>',
                        ...
                        <?php if (get_post_meta(get_the_ID(),
                            ...
                            '<div class="thumbnail">',
                                    ...
                                    '<a href="#schoolv3-carousel" data-slide-to="5"><img class="destination-img" src="'
                                    . $additional_schoolv3_image6
                                    . '" data-bs-toggle="modal" data-bs-target="#travelTableModal" alt="The Fly Shop Images"></a>',
                        ...
                        <?php if (get_post_meta(get_the_ID(),
                            ...
                            '<div class="thumbnail">',
                                    ...
                                    '<a href="#schoolv3-carousel" data-slide-to="6"><img class="destination-img" src="'
                                    . $additional_schoolv3_image7
                                    . '" data-bs-toggle="modal" data-bs-target="#travelTableModal" alt="The Fly Shop Images"></a>',
                        ...
                        <?php if (get_post_meta(get_the_ID(),
                            ...
                            '<div class="thumbnail">',
                                    ...
                                    '<a href="#schoolv3-carousel" data-slide-to="7"><img class="destination-img" src="'
                                    . $additional_schoolv3_image8
                                    . '" data-bs-toggle="modal" data-bs-target="#travelTableModal" alt="The Fly Shop Images"></a>',
            ...
            <div class="modal-content">
                ...
                <div id="travel-carousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-indicators">
                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image1', true)) { ?>
                            <button type="button" data-bs-target="#schoolv3-carousel" data-bs-slide-to="0" class="active"
                                    aria-current="true" aria-label="Slide 1"></button>
                        <?php } ?>

                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image2', true)) { ?>
                            <button type="button" data-bs-target="#schoolv3-carousel" data-bs-slide-to="1"
                                    aria-label="Slide 2"></button>
                        <?php } ?>

                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image3', true)) { ?>
                            <button type="button" data-bs-target="#schoolv3-carousel" data-bs-slide-to="2"
                                    aria-label="Slide 3"></button>
                        <?php } ?>

                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image4', true)) { ?>
                            <button type="button" data-bs-target="#schoolv3-carousel" data-bs-slide-to="3"
                                    aria-label="Slide 4"></button>
                        <?php } ?>

                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image5', true)) { ?>
                            <button type="button" data-bs-target="#schoolv3-carousel" data-bs-slide-to="4"
                                    aria-label="Slide 5"></button>
                        <?php } ?>

                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image6', true)) { ?>
                            <button type="button" data-bs-target="#schoolv3-carousel" data-bs-slide-to="5"
                                    aria-label="Slide 6"></button>
                        <?php } ?>

                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image7', true)) { ?>
                            <button type="button" data-bs-target="#schoolv3-carousel" data-bs-slide-to="6"
                                    aria-label="Slide 7"></button>
                        <?php } ?>

                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image8', true)) { ?>
                            <button type="button" data-bs-target="#schoolv3-carousel" data-bs-slide-to="7"
                    ...
                    <div class="carousel-inner">
                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image1', true)) { ?>
                            <div class="carousel-item active">
                                <img class="d-block w-100 destination-img"
                                     src="<?php echo $additional_schoolv3_image1; ?>" data-bs-toggle="modal"
                        ...
                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image2', true)) { ?>
                            <div class="carousel-item">
                                <img class="d-block w-100 destination-img"
                                     src="<?php echo $additional_schoolv3_image2; ?>" data-bs-toggle="modal"
                                     data-bs-target="#travelTableModal"
                                     alt="The Fly Shop World Fly Fishing Travel">
                            </div>
                        <?php } ?>
                        ...
                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image3', true)) { ?>
                            <div class="carousel-item">
                                <img class="d-block w-100 destination-img"
                                     src="<?php echo $additional_schoolv3_image3; ?>" data-bs-toggle="modal"
                                     data-bs-target="#travelTableModal"
                                     alt="The Fly Shop World Fly Fishing Travel">
                            </div>
                        <?php } ?>
                        ...
                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image4', true)) { ?>
                            <div class="carousel-item">
                                <img class="d-block w-100 destination-img"
                                     src="<?php echo $additional_schoolv3_image4; ?>" data-bs-toggle="modal"
                                     data-bs-target="#travelTableModal"
                                     alt="The Fly Shop World Fly Fishing Travel">
                            </div>
                        <?php } ?>
                        ...
                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image5', true)) { ?>
                            <div class="carousel-item">
                                <img class="d-block w-100 destination-img"
                                     src="<?php echo $additional_schoolv3_image5; ?>" data-bs-toggle="modal"
                                     data-bs-target="#travelTableModal"
                                     alt="The Fly Shop World Fly Fishing Travel">
                            </div>
                        <?php } ?>
                        ...
                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image6', true)) { ?>
                            <div class="carousel-item">
                                <img class="d-block w-100 destination-img"
                                     src="<?php echo $additional_schoolv3_image6; ?>" data-bs-toggle="modal"
                                     data-bs-target="#travelTableModal"
                                     alt="The Fly Shop World Fly Fishing Travel">
                            </div>
                        <?php } ?>
                        ...
                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image7', true)) { ?>
                            <div class="carousel-item">
                                <img class="d-block w-100 destination-img"
                                     src="<?php echo $additional_schoolv3_image7; ?>" data-bs-toggle="modal"
                                     data-bs-target="#travelTableModal"
                                     alt="The Fly Shop World Fly Fishing Travel">
                            </div>
                        <?php } ?>
                        ...
                        <?php if (get_post_meta(get_the_ID(), 'additional-schoolv3-image8', true)) { ?>
                            <div class="carousel-item">
                                <img class="d-block w-100 destination-img"
                                     src="<?php echo $additional_schoolv3_image8; ?>" data-bs-toggle="modal"
                                     data-bs-target="#travelTableModal"
                                     alt="The Fly Shop World Fly Fishing Travel">
                            </div>
                        <?php } ?>
