...
/**
 * This is the meta field file for the Guide Service Template
 * /wp-content/plugins/sbm-image-field/includes/signature_image_field.php
 */

$signature_video_poster = '';
if ( has_post_thumbnail() ) {
 $signature_video_poster = get_the_post_thumbnail_url( get_the_ID(), 'full' );
}
...
if ( ! empty( $signature_hero_video_url ) && ! empty( $signature_video_poster ) ) : ?>
 <div id="banner" class="container-fluid travel-template-hero p-0">
  <div class="hero-image position-relative guide-temp-hero-overlay video-control">
   <div class="overlay"></div>
   <video id="sections-private-background-video" class="private-temp-video"
          autoplay
          playsinline loop
          muted
          poster="<?php echo $signature_video_poster; ?>">
    <source src="<?php echo $signature_hero_video_url; ?>" type="video/mp4">
   </video>
   <!-- Overlay Content -->
...
<?php elseif ( empty( $signature_hero_video_url ) ) : ?>
 <div id="banner" class="container-fluid travel-template-hero p-0">
  <div class="hero-image guide-temp-hero-overlay position-relative">
   <div class="overlay"></div>
...
<?php elseif ( ! empty( $signature_hero_video_url ) && ! empty( $signature_video_poster ) ) : ?>  ?>
   ...
   <div class="col-xs-12 col-sm-12 col-md-12">
    <div class="carousel carousel-showallmove1 slide" id="itemslider">
     ...
     <div id="slider-control">
      <a class="left carousel-control" href="#itemslider" data-slide="prev"><i class="fa fa-chevron-left fa-4x"
                                                                               aria-hidden="true"></i></a>
      <a class="right carousel-control" href="#itemslider" data-slide="next"><i class="fa fa-chevron-right fa-4x"
                                                                                aria-hidden="true"></i></a>
     </div>
...
<?php endif; ?>
 ...
 <div id="guide-template-grid" class="mobile-container container mt-5 mb-5 pt-5 pb-5">
...
<?php if ( $signature_image_1 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 one">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_1_title_link; ?>" target="_self"
                                 title="Signature Destination"><?php echo $signature_image_1_title; ?></a></h3>
...
if ( $signature_image_2 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 two">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_2_title_link; ?>" target="_self"
                                 title="Signature Destination"><?php echo $signature_image_2_title; ?></a></h3>
...
if ( $signature_image_3 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 three">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_3_title_link; ?>" target="_self"
                                 title="Signature Destination"><?php echo $signature_image_3_title; ?></a></h3>
...
<?php if ( $signature_image_4 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 four">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_4_title_link; ?>" target="_self"
                                 title="Signature Destination"><?php echo $signature_image_4_title; ?></a></h3>
...
if ( $signature_image_5 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 five">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_5_title_link; ?>" target="_self"
                                 title="Signature Destination"><?php echo $signature_image_5_title; ?></a></h3>
...
if ( $signature_image_6 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 six">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_6_title_link; ?>" target="_self"
                                 title="Signature Destination"><?php echo $signature_image_6_title; ?></a></h3>
...
if ( $signature_image_7 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 seven">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_7_title_link; ?>" target="_self"
                                 title="Signature Destination"><?php echo $signature_image_7_title; ?></a></h3>
...
if ( $signature_image_8 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 eight">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_8_title_link; ?>" target="_self"
                                 title="Signature Destination"><?php echo $signature_image_8_title; ?></a></h3>
...
if ( $signature_image_9 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 nine">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_9_title_link; ?>" target="_self"
                                 title="Signature Destination"><?php echo $signature_image_9_title; ?></a></h3>
...
if ( $signature_image_10 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 ten">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_10_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_10_title; ?></a></h3>
...
if ( $signature_image_11 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 eleven">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_11_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_11_title; ?></a></h3>
...
if ( $signature_image_12 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 tweleve">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_12_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_12_title; ?></a></h3>
...
if ( $signature_image_13 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 thirteen">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_13_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_13_title; ?></a></h3>
...
if ( $signature_image_14 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 fouteen">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_14_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_14_title; ?></a></h3>
...
if ( $signature_image_15 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 fifteen">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_15_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_15_title; ?></a></h3>
...
if ( $signature_image_16 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 sixteen">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_16_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_16_title; ?></a></h3>
...
if ( $signature_image_17 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 seventeen">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_17_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_17_title; ?></a></h3>
...
if ( $signature_image_18 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 eighteen">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_18_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_18_title; ?></a></h3>
...
if ( $signature_image_19 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 nineteen">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_19_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_19_title; ?></a></h3>
...
if ( $signature_image_20 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 twenty">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_20_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_20_title; ?></a></h3>
...
if ( $signature_image_21 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 twentyone">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_21_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_21_title; ?></a></h3>
...
if ( $signature_image_22 !== '' ) : ?>
 ...
 <div class="col-md-6 col-lg-6 twentytwo">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_22_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_22_title; ?></a></h3>
...
if ( $signature_image_23 !== '' ) : ?>
 <div class="col-md-6 col-lg-6 twentythree">
  <div class="thumbnail signature-text-color">
   ...
   <div id="" class="widget-section">
    <div class="caption sig-caption">
     <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_23_title_link; ?>"
                                 target="_self"
                                 title="Signature Destination"><?php echo $signature_image_23_title; ?></a></h3>
...
if ( $signature_image_24 !== '' ) : ?>
 ...
 <div class="thumbnail signature-text-color">
  ...
  <section id="" class="widget-section">
   <div class="caption sig-caption">
    <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_24_title_link; ?>" target="_self"
                                title="Signature Destination"><?php echo $signature_image_24_title; ?></a></h3>
...
if ( $signature_image_25 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_25_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_25_title; ?></a></h3>
...
if ( $signature_image_26 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_26_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_26_title; ?></a></h3>
...
if ( $signature_image_27 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_27_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_27_title; ?></a></h3>
...
if ( $signature_image_28 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_28_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_28_title; ?></a></h3>
...
if ( $signature_image_29 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_29_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_29_title; ?></a></h3>
...
if ( $signature_image_30 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_30_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_30_title; ?></a></h3>
...
if ( $signature_image_31 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_31_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_31_title; ?></a></h3>
...
if ( $signature_image_32 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_32_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_32_title; ?></a></h3>
...
if ( $signature_image_33 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_33_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_33_title; ?></a></h3>
...
if ( $signature_image_34 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_34_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_34_title; ?></a></h3>
...
if ( $signature_image_35 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_35_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_35_title; ?></a></h3>
...
if ( $signature_image_36 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_36_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_36_title; ?></a></h3>
...
if ( $signature_image_37 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_37_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_37_title; ?></a></h3>
...
if ( $signature_image_38 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_38_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_38_title; ?></a></h3>
...
if ( $signature_image_39 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_39_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_39_title; ?></a></h3>
...
if ( $signature_image_40 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_40_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_40_title; ?></a></h3>
...
if ( $signature_image_41 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_41_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_41_title; ?></a></h3>
...
if ( $signature_image_42 !== '' ) : ?>
 ...
 <div id="" class="widget-section">
  <div class="caption sig-caption">
   <h3 class="widget-title"><a class="thumbnail-h3" href="<?php echo $signature_image_42_title_link; ?>" target="_self"
                               title="Signature Destination"><?php echo $signature_image_42_title; ?></a></h3>
...
<? php// endif; ?>
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
   <div class="modal-content">
    <div class="modal-header">
     <div class="modal-title" id="primeTravelTempmodalLabel"><img src="<?php echo get_theme_mod( 'pt_mdl_logo' ); ?>"
 ...
 <section id="front-page-cta">
  <div class="container-fluid container-row background-image-cta d-flex align-items-center mt-5" data-aos="fade-in"
       data-aos-duration="1500" data-aos-delay="500" data-aos-once="true">
