...
<?php if ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'AntelopeCreek' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'BaileyCreek' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'BattleCreek' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'BaumLake' ) : ?>

 <div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
   <div class="modal-body">
    <div class="row" id="modal-style">
     <div id="featuredreport4">
      <div class="report-panel">
       <div class="container-fluid">
        <div class="row">
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'Bollibokka' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'CircleSeven' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'ClearCreek' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'FallRiver' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'GoldRiver' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'HatCreek' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'HatCreekRanch' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'IronCanyon' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'KlamathRiver' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'KeswickRes' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'LakeShasta' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'LewistonLake' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'LowerSac' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'LukLake' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'ManzanitaLake' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'McCloudReservoir' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'McCloudRiver' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'OasisSprings' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'PedrottiPonds' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'PitRiver' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'PyramidLake' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'RockCreek' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'SugarCreek' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'Trinity' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'UpperSac' ) : ?>
...
<?php elseif ( get_post_meta( get_the_ID(), 'meta-four-select', true ) == 'WilksPond' ) : ?>
