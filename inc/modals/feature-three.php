...
<?php if (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'AntelopeCreek') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'BaileyCreek') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'BattleCreek') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'BaumLake') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'Bollibokka') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'CircleSeven') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'ClearCreek') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'FallRiver') : ?>

    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row" id="modal-style">
                    <div id="featuredreport2">
                        <div class="report-panel">
                            <div class="container-fluid">
                                <div class="row">
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'GoldRiver') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'HatCreek') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'HatCreekRanch') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'IronCanyon') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'KlamathRiver') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'KeswickRes') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'LakeShasta') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'LewistonLake') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'LowerSac') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'LukLake') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'ManzanitaLake') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'McCloudReservoir') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'McCloudRiver') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'OasisSprings') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'PedrottiPonds') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'PitRiver') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'PyramidLake') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'RockCreek') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'SugarCreek') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'Trinity') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'UpperSac') : ?>
...
<?php elseif (get_post_meta(get_the_ID(), 'meta-three-select', true) == 'WilksPond') : ?>
